...
const About = () => {
  return (
    <div className={classes.page}>
      ...
      <p>
        cClintock wrote to Before & After to explain his discovery; “What I find
        remarkable is that this text has been the industry's standard dummy text
        ever since some printer in the 1500s took a galley of type and scrambled
        it to make a type specimen book; it has survived not only four centuries
        of letter-by-letter resetting but even the leap into electronic
        ...
        scrambled, it became as incomprehensible as Greek; the phrase 'it's
